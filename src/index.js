...
//   // image.style.display = 'flex column';
//   // image.classList = 'doggoo'
//   return image;
// }
// imageData.forEach(val =>  {
//   // console.log(valL);
//   // console.log(val.imageURL)
//   const imgElement = makeImage(val);
...
// console.log(panelData) // log the linkData
...
panelData.forEach((val) => {
  accordion.appendChild(makePanel(val))
})
...
linkData.forEach((val) => {
  linkAnchor.appendChild(linkMaker(val));
})